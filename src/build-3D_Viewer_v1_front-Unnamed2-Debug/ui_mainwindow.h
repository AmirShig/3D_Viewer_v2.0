...
"}"));
        ...
        openFilePushBtn = new QPushButton(centralwidget);
        openFilePushBtn->setObjectName("openFilePushBtn");
        openFilePushBtn->setGeometry(QRect(930, 180, 421, 41));
        QFont font2;
        font2.setPointSize(20);
        font2.setBold(false);
        openFilePushBtn->setFont(font2);
        openFilePushBtn->setStyleSheet(QString::fromUtf8("QPushButton{\n"
...
"}"));
        ...
        myGl = new QOpenGLWidget(centralwidget);
        myGl->setObjectName("myGl");
        myGl->setGeometry(QRect(10, 10, 901, 741));
        myGl->setCursor(QCursor(Qt::OpenHandCursor));
        cleanPushButton = new QPushButton(centralwidget);
        cleanPushButton->setObjectName("cleanPushButton");
        cleanPushButton->setGeometry(QRect(1150, 710, 201, 41));
        cleanPushButton->setFont(font2);
        cleanPushButton->setStyleSheet(QString::fromUtf8("QPushButton{\n"
"	background-color: rgb(75, 75, 75);\n"
"	\n"
"	border-color: solid black;\n"
"	border-width: 1px;\n"
...
"}"));
        ...
        setBckgColor = new QPushButton(verticalLayoutWidget);
        setBckgColor->setObjectName("setBckgColor");
        QSizePolicy sizePolicy3(QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
        sizePolicy3.setHorizontalStretch(0);
        sizePolicy3.setVerticalStretch(0);
        sizePolicy3.setHeightForWidth(setBckgColor->sizePolicy().hasHeightForWidth());
        setBckgColor->setSizePolicy(sizePolicy3);
        setBckgColor->setFont(font4);
        setBckgColor->setStyleSheet(QString::fromUtf8("QPushButton{\n"
"	background-color: rgb(75, 75, 75);\n"
"	\n"
"	border-color: solid black;\n"
"	border-width: 1px;\n"
...
"}"));
        ...
        horizontalLayout_5->addWidget(setBckgColor);
        ...
        setLinesColor = new QPushButton(verticalLayoutWidget);
        setLinesColor->setObjectName("setLinesColor");
        sizePolicy3.setHeightForWidth(setLinesColor->sizePolicy().hasHeightForWidth());
        setLinesColor->setSizePolicy(sizePolicy3);
        setLinesColor->setFont(font4);
        setLinesColor->setStyleSheet(QString::fromUtf8("QPushButton{\n"
"	background-color: rgb(75, 75, 75);\n"
"	\n"
"	border-color: solid black;\n"
"	border-width: 1px;\n"
...
"}"));
        ...
        horizontalLayout_2->addWidget(setLinesColor);
        ...
        setVertexesColor = new QPushButton(verticalLayoutWidget);
        setVertexesColor->setObjectName("setVertexesColor");
        sizePolicy3.setHeightForWidth(setVertexesColor->sizePolicy().hasHeightForWidth());
        setVertexesColor->setSizePolicy(sizePolicy3);
        setVertexesColor->setFont(font4);
        setVertexesColor->setStyleSheet(QString::fromUtf8("QPushButton{\n"
"	background-color: rgb(75, 75, 75);\n"
"	\n"
"	border-color: solid black;\n"
"	border-width: 1px;\n"
...
"}"));
        ...
        horizontalLayout_4->addWidget(setVertexesColor);
...
"}"));
    ...
    void retranslateUi(QWidget *View)
    {
        ...
        openFilePushBtn->setText(QCoreApplication::translate("View", "Open file", nullptr));
        label->setText(QCoreApplication::translate("View", "Information", nullptr));
        cleanPushButton->setText(QCoreApplication::translate("View", "All Clean", nullptr));
        ...
        setBckgColor->setText(QCoreApplication::translate("View", "Set color", nullptr));
        ...
        setLinesColor->setText(QCoreApplication::translate("View", "Set color", nullptr));
        ...
        setVertexesColor->setText(QCoreApplication::translate("View", "Set color", nullptr));
